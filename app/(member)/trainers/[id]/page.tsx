      ...
      <div className="profile-main">
        ...
        <div className="profile-body-grid">
          <div>
            ...
            <TrainerPosts trainerId={id} trainerName={displayName} stableName={t.stable_name ?? null} stableLocation={t.location ?? null} trainerPhotoUrl={coverUrl} viewerId={userId} />
          </div>
